...
The sixth file required by Apple School Manager, locations.csv, needs to exist in the output destination, uploads, prior to runing the script and consists of the Description and Abbreviation fields from Veracross School Levels. This file is created and edited manually due to its small size and static nature. The six files used in the upload to Apple School Manager must have these exact names or they upload will fail.
